  ...
  return (
    <View style={{ flex: 1 }}>
        <Card style={styles.backColor}>
            <Card.Cover style={styles.backColorTop} source={require('../assets/ImgCarana/Arracadas.jpg')} />
        ...
        <View style={styles.ViewDescription}>
            ...
            Confía en esa emoción desconocida, estos aretes se complementan a la perfección con tu outfit, son ideales para usarlos en cualquier ocasión, con ellos obtendrás un luck exclusivo que te dará confianza para ir a donde quieras.
            </Text>
        </View>
        <TouchableOpacity style={styles.cartTouch} onPress={() => alert('Se guardó Arracadas en el carrito')}>
