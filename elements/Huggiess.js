  ...
  return (
    <View style={{ flex: 1 }}>
        <Card style={styles.backColor}>
            <Card.Cover style={styles.backColorTop} source={require('../assets/ImgCarana/Huggies.jpg')} />
        ...
        <View style={styles.ViewDescription}>
            ...
            Arete Hugguie acero inoxidable dordo de 4x 9 mm 
            </Text>
        </View>
        <TouchableOpacity style={styles.cartTouch} onPress={() => alert('Se guardó Huggies en el carrito')}>
