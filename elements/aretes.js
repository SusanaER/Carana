  ...
  return (
    <View style={{ flex: 1 }}>
        <Card style={styles.backColor}>
            <Card.Cover style={styles.backColorTop} source={require('../assets/ImgCarana/Aretes.jpg')} />
        ...
        <View style={styles.ViewDescription}>
            ...
            <Text style={styles.txtDescription}>
                Aretes de Acero inoxidable, Joyeria de Acero inoxidable Etiquetas: Acero Inoxidable, Aretes, Joyeria
            </Text>
        </View>
        <TouchableOpacity style={styles.cartTouch} onPress={() => alert('Se guardó Aretes en el carrito')}>
