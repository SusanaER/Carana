  ...
  return (
    <View style={{ flex: 1 }}>
        <Card style={styles.backColor}>
            <Card.Cover style={styles.backColorTop} source={require('../assets/ImgCarana/Iniciales.jpg')} />
        ...
        <View style={styles.ViewDescription}>
            ...
            <Text style={styles.txtDescription}>
                Collar de acero de 38cm + colgante de anilla palanca y chapa de 3cm en total, chapa de medida 1,5cm de diámetro. Un bonito collar para llevar en primavera verano con todos tus looks. El baño es resistente al agua y no deja mancha verde en la piel. 
            </Text>
        </View>
        <TouchableOpacity style={styles.cartTouch} onPress={() => alert('Se guardó Iniciales en el carrito')}>
