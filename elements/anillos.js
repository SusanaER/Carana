  ...
  return (
    <View style={{ flex: 1 }}>
        <Card style={styles.backColor}>
            <Card.Cover style={styles.backColorTop} source={require('../assets/ImgCarana/Anillos.jpg')} />
        ...
        <View style={styles.ViewDescription}>
            ...
            <Text style={styles.txtDescription}>
                Los Anillos Ajustables te harán lucir una mano increíble,
                Son diferentes modelos que se adaptan al tamaño de tus dedos.
            </Text>
        </View>
        <TouchableOpacity style={styles.cartTouch} onPress={() => alert('Se guardó Anillos ajustables en el carrito')}>
